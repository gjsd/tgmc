...
stmt=con.createStatement();
	...
	rs=stmt.executeQuery("select distinct proname from products where cat='"+request.getParameter("q")+"'");
	...
	while(rs.next()){ 
	      response.getWriter().write("<option>"+rs.getString("proname")+"</option>");
      	          }
